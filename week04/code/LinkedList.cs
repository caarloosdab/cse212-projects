...
public class LinkedList : IEnumerable<int>
{
    ...
    public void RemoveTail()
    {
        ...
        {
            _tail.Prev!.Next = null; // Disconnect the second node from the last node
    ...
    public void Remove(int value)
    {
        ...
        while (curr is not null)
        {
            if (curr.Data == value)
            {
                // If the node to be removed is the head of the list, then we need to update
                if (curr == _head)
                {
                    RemoveHead(); //Reuse logic
                }
                else if (curr == _tail)
                {
                    RemoveTail(); //Reuse logic
                }
                else
                {
